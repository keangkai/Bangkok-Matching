...
<body class="animsition">
                        ...
                        <div class="row">
							...
							<div class="col-lg-12">
								<div class="user-data" >
									...
									<div class="row">
                                        <div class="couple-content w-100 mt--30">
                                            <div id="display"></div>
                                        </div>
    ...
    <script language="javascript">
        ...
        $('.myBox input:checkbox').change(function(){
            ...
            var openFormTag = '<form action="send_mail.php" method="post"><div class="row">';
            var tempValue = '';
            var heartImage = `
                <div class="col-lg-2 col-md-2 col-sm-2 text-center">
                    <img style="margin:50px 0;" src="images/admin/2.png" alt="">
                </div>`;
            if (count <= 2) {
                tempValue = $('.myBox input:checkbox').map(function(n){
                    if(this.checked){
                        ...
                        <?php
                            echo '<img src="data:image/jpeg;base64,'.base64_encode( $images ).'" alt="" />';
                        ?>
                            </div>
                        ${this.value}
                        <input type="hidden" value="${$(this).data('email')}" name="mail_to[]">
                        </div>`;
                    };
                }).get().join(heartImage)
                var submitButton = '</div><input type="submit" id="send-email" style="display:none;">';
                var closeFormTag = '</form>';
                console.log(count);
                $('#display').html(openFormTag + tempValue + submitButton + closeFormTag);
            }
            else {
                alert('You can select maximum 2');
                this.checked = false;
                count -= 1;
            }
